...
import '../../modelo/ProductoModelo.dart';
...
class ProductoBloc extends Bloc<ProductoEvent, ProductoState> {
  ...
  ProductoBloc(this._productoRepository, this._unidadMedidaRepository, this._categoriaRepository, this._marcaRepository) : super(ProductoInitialState()) {
